================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : UsbTest Project Overview
===============================================================================

The application wizard has created this UsbTest application for 
...
UsbTestDlg.h, UsbTestDlg.cpp - the dialog
    ...
    in UsbTest.rc, which can be edited in Microsoft Visual C++.
