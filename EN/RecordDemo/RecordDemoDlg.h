...
class CRecordDemoDlg : public CDialog
{
// Construction
public:
	CRecordDemoDlg(CWnd* pParent = NULL);	// standard constructor

// Dialog Data
	enum { IDD = IDD_RECORDDEMO_DIALOG };

	protected:
	virtual void DoDataExchange(CDataExchange* pDX);	// DDX/DDV support


	static void CALLBACK USBCallBackEvent(WORD wEventCode, int nReference,DWORD dwParam,DWORD dwDeviceID);
